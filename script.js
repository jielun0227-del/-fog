...
const AIRPORTS_DATA = [
  {
    ...
    url: "https://aolaiyun01.kuailiaff.com/#/?code=OYKzjZdm",
  ...
  },
  {
    ...
    url: "https://ly888.liydl.com:8888/#/register?code=JbdpSKp7",
    priceText: "¥96 / ¥5·100GB/月",
    annualPrice: 96,
    monthlyPrice: 5.0,
    monthlyTraffic: 100,
    hasOneTime: true,
    hasTrial: false,
    lineType: "高速隧道中转 / BGP优化",
    unlockInfo: "4K 流媒体 / ChatGPT / Claude",
    tags: ["budget", "onetime"],
    speedMbps: 860,
    pingMs: 34,
    desc: "鲤云主打平民性价比与极速隧道中转，起步月付仅 5 元 (100G)，提供 59 元不限时流量包及特惠年付套餐。"
  },
  {
    id: "shanshuiyun",
    name: "山水云",
    logo: "./images/shanshuiyun_logo.png",
    url: "https://ss2.byvvcsx.com/#/register?code=9zcDmoMN",
    priceText: "¥88 / ¥12·100GB/月",
    annualPrice: 88,
    monthlyPrice: 12.0,
    monthlyTraffic: 100,
    hasOneTime: true,
    hasTrial: false,
    lineType: "BGP 中转 / 国风专线",
    unlockInfo: "Netflix / YouTube 8K / AI 解锁",
    tags: ["budget", "onetime"],
    speedMbps: 840,
    pingMs: 35,
    desc: "山水云采用琴棋书特色套餐命名，包含 36 元季付轻量包、88 元年付包及 99 元不限时 100G 叠加包。"
  },
  {
    id: "miaomiaoyun",
    name: "秒秒云",
    logo: "./images/miaomiaoyun_logo.png",
    url: "https://m3.mouhiojl.com/#/register?code=JF1wQpdl",
    priceText: "¥88 / ¥9·128GB/月",
    annualPrice: 88,
    monthlyPrice: 9.0,
    monthlyTraffic: 128,
    hasOneTime: true,
    hasTrial: false,
    lineType: "极速中转 / 优化入口",
    unlockInfo: "流媒体 4K 全解锁 / OpenAI",
    tags: ["budget", "onetime"],
    speedMbps: 850,
    pingMs: 36,
    desc: "秒秒云推出探花 (9元/128G)、榜眼 (15元/256G)、状元 (29元/512G) 三大主力包与 59 元不限时流量包。"
  },
  {
    id: "jinyun",
    name: "锦云",
    ...
    hasTrial: false,
    lineType: "跨境中转 / 办公优选",
    unlockInfo: "全平台流媒体 / 办公 AI 解锁",
    tags: ["budget", "onetime"],
    speedMbps: 850,
    pingMs: 35,
    desc: "锦云提供 6 元体验版、9 元日常版与 16 元办公版，支持 18 元季付特惠与 99 元不限时 100G 流量包。"
  },
  {
    id: "xiongmao",
    name: "熊猫 Cloud",
    ...
    hasOneTime: true,
    hasTrial: false,
    lineType: "BGP 中转 / 大流量集群",
    unlockInfo: "8K 极清视频 / ChatGPT 4o / 社交",
    tags: ["budget", "onetime"],
    speedMbps: 880,
    pingMs: 32,
    desc: "熊猫 Cloud 主打流量大碗宽面，月付 6 元即给 300GB、10 元给 600GB，并有 66 元不限时 600GB 海量包。"
  },
  {
    id: "yuntu",
    name: "云图",
