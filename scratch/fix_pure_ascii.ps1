...
foreach ($file in $htmlFiles) {
    ...
    $content = $content.Replace($old1, $siteTitle)
    $content = $content.Replace($old2, $teamTitle)
    $content = $content.Replace($old3, $siteTitle)
    $content = $content.Replace($old4, $brandName)
...
Write-Output "PURE_ASCII_SUCCESS"
